...
class o extends s {
  ...
  json() {
    const t = { version: this.version }
    return (
      e(t, "generator", this.generator),
      e(t, "minVersion", this.minVersion),
      e(t, "copyright", this.copyright),
      e(t, "extensions", this.generator),
      e(t, "extras", this.extras),
      t
    )
  }
  static readFromJson(e) {
    const t = new o()
    if (!i.includes(e.version))
      throw new Error(`[GLTFAsset.readFromJson()] 参数 version：${e.version} 不合法，请检查`)
    if (((t.version = e.version), void 0 !== e.minVersion)) {
      if (!i.includes(e.minVersion))
        throw new Error(
...
const v = Object.freeze(Object.values(p))
var b,
  g = p
!(function (e) {
...
const T = Object.freeze(Object.values(b))
var x,
  y = b
!(function (e) {
...
const w = Object.freeze(Object.values(x))
var L,
  E = x
!(function (e) {
  ;(e[(e.POINTS = 0)] = "POINTS"),
...
const O = Object.freeze(Object.values(L))
var _,
  F = L
!(function (e) {
  ;(e.POSITION = "position"),
...
class B extends s {
  ...
  validate() {
    return (
      this.componentType === m.UNSIGNED_BYTE ||
      this.componentType === m.UNSIGNED_INT ||
      this.componentType === m.UNSIGNED_SHORT
    )
  }
  json() {
    if (!this.validate())
    ...
    return t(s, this.extensions), e(s, "extras", this.extras), s
  }
  static readFromJson(e) {
    const t = new B()
    return (
      ...
      d.includes(e.componentType) && (t.componentType = e.componentType),
      t
    )
  }
}
class I extends s {
  ...
  json() {
    ...
    return (
      e(s, "byteOffset", this.byteOffset), t(s, this.extensions), e(s, "extras", this.extras), s
    )
  }
  static readFromJson(e) {
    const t = new I()
...
class j extends s {
  ...
  static readFromJson(e) {
    const t = new j()
    return (
      (t.indices = B.readFromJson(e.indices)),
      (t.values = I.readFromJson(e.values)),
      (t.extras = e.extras),
      t
    )
  }
...
class C extends s {
  ...
  json() {
    ...
    return (
      ...
      e(s, "min", this.min),
      e(s, "name", this.name),
      e(s, "normalized", this.normalized),
      e(s, "sparse", void 0 !== this.sparse ? this.sparse.json() : void 0),
      e(s, "bufferView", this.bufferView),
      e(s, "byteOffset", this.byteOffset),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
  }
  static fromJson(e) {
    const t = new C()
    if (!d.includes(e.componentType))
      throw new Error("[GLTFAccessor.readFromJson()] 属性 componentType 非法")
    if (((t.componentType = e.componentType), (t.count = e.count), !h.includes(e.type)))
      throw new Error("[readGLTF() readAccessors()] 属性 type 非法")
    return (
      (t.type = e.type),
      (t.max = e.max),
      (t.min = e.min),
      void 0 !== e.sparse && (t.sparse = j.readFromJson(e.sparse)),
...
class P extends s {
  ...
  json() {
    ...
    return e(s, "uri", this.uri), t(s, this.extensions), e(s, "extras", this.extras), s
  }
  static fromJson(e) {
    const t = new P()
    return (
      ...
      t.uri &&
        ...
        (t.bufferData = M(t.uri.substr(t.uri.indexOf(",") + 1))),
...
const V = Object.freeze(Object.values(U))
var D = U
class z extends s {
  constructor() {
  ...
  json() {
    ...
    return (
      (this.target !== D.ARRAY_BUFFER && this.target !== D.ELEMENT_ARRAY_BUFFER) ||
        e(s, "target", this.target),
      e(s, "byteOffset", this.byteOffset),
      4 !== this.byteStride && e(s, "byteStride", this.byteStride),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
  ...
  static fromJson(e) {
    ...
    return (
      ...
      (t.byteOffset = e.byteOffset),
      (t.extras = e.extras),
      void 0 !== e.target && V.includes(e.target) && (t.target = e.target),
      t
    )
  }
}
class k extends s {
  ...
  json() {
    ...
    return e(s, "name", this.name), t(s, this.extensions), s
  }
  static fromJson(e) {
    const t = new k()
...
class H extends s {
  ...
  json() {
    ...
    const s = {}
    e(s, "mesh", this.mesh),
      e(s, "rotation", this.rotation),
      e(s, "translation", this.translation),
      e(s, "scale", this.scale)
    const r = this.matrix
    return (
      r &&
        ((1 === r[0] && 1 === r[5] && 1 === r[10] && 1 === r[15]) || e(s, "matrix", this.matrix)),
      e(s, "weights", this.weights),
      e(s, "skin", this.skin),
      e(s, "camera", this.camera),
      e(s, "name", this.name),
      this.children && 0 !== this.children.length && e(s, "children", this.children),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
...
class W {
  ...
  json() {
    const t = { POSITION: this.position }
    return (
      e(t, "NORMAL", this.normal),
      e(t, "TANGENT", this.tangent),
      e(t, "TEXCOORD_0", this.uv0),
      e(t, "TEXCOORD_1", this.uv1),
      e(t, "COLOR_0", this.color0),
      e(t, "JOINTS_0", this.joints0),
      e(t, "WEIGHTS_0", this.weights0),
      e(t, "_BATCHID", this._batchid),
      t
    )
  }
}
class Y extends s {
  constructor() {
    super(), (this.attributes = new W()), (this.mode = F.TRIANGLES)
  }
  getAccessor(e) {
  ...
  json() {
    ...
    return (
      this.mode !== F.TRIANGLES && void 0 !== this.mode && e(s, "mode", this.mode),
      e(s, "indices", this.indices),
      e(s, "material", this.material),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
  ...
  static fromJson(e) {
    ...
    if (((t.indices = e.indices), (t.material = e.material), void 0 !== e.mode && 4 !== e.mode)) {
      if (!O.includes(e.mode))
        throw new Error(`[GLTFPrimitive.readFromJson()] mode：${e.mode} 不合法，请检查`)
      t.mode = e.mode
    }
    return (t.attributes = W.fromJson(e.attributes)), t
  }
}
class Q extends s {
  constructor() {
  ...
  json() {
    const s = { primitives: this.primitives.map((e) => e.json()) }
    return e(s, "weights", this.weights), e(s, "name", this.name), t(s, this.extensions), s
  }
  static fromJson(e) {
    const t = new Q()
    return (
      (t.name = e.name),
      (t.primitives = e.primitives.map((e) => Y.fromJson(e))),
      (t.weights = e.weights),
      (t.extras = e.extras),
      t
    )
...
class q extends s {
  ...
  static fromJson(e) {
    const t = new q(e.index, e.texCoord)
...
class $ extends q {
  ...
  json() {
    ...
    const s = super.json()
    return e(s, "scale", this.scale), t(s, this.extensions), e(s, "extras", this.extras), s
  }
  static fromJson(e) {
    const t = new $(e.index, e.texCoord, e.scale)
    return (t.extras = e.extras), t
  }
}
class X extends s {
  ...
  json() {
    ...
    return (
      void 0 !== this.baseColorFactor &&
        ...
        e(s, "baseColorFactor", this.baseColorFactor),
      e(
        s,
        "baseColorTexture",
  ...
  static fromJson(e) {
    ...
    return (
      ...
      void 0 !== e.baseColorTexture && (t.baseColorTexture = q.fromJson(e.baseColorTexture)),
      void 0 !== e.metallicRoughnessTexture &&
        (t.metallicRoughnessTexture = q.fromJson(e.metallicRoughnessTexture)),
      t
    )
  }
}
class Z extends s {
  ...
  json() {
    ...
    return (
      ...
      e(s, "normalTexture", void 0 !== this.normalTexture ? this.normalTexture.json() : void 0),
      e(
        s,
        "emissiveTexture",
        void 0 !== this.emissiveTexture ? this.emissiveTexture.json() : void 0
      ),
      e(s, "emissiveFactor", this.emissiveFactor),
      e(
        s,
        "alphaMode",
  ...
  static fromJson(e) {
    ...
    return (
      ...
      void 0 !== e.pbrMetallicRoughness &&
        (t.pbrMetallicRoughness = X.fromJson(e.pbrMetallicRoughness)),
      void 0 !== e.normalTexture && (t.normalTexture = $.fromJson(e.normalTexture)),
      void 0 !== e.emissiveTexture && (t.emissiveTexture = q.fromJson(e.emissiveTexture)),
      void 0 !== e.alphaMode && v.includes(e.alphaMode) && (t.alphaMode = e.alphaMode),
...
class K extends s {
  ...
  json() {
    ...
    return (
      e(s, "name", this.name),
      e(s, "source", this.source),
      e(s, "sampler", this.sampler),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
...
var te = R(function (e, t) {
  ...
  class s {
    ...
    readUtf8(e = 1) {
      return ee.decode(this.readBytes(e))
    }
    writeBoolean(e) {
    ...
    writeUtf8(e) {
      return this.writeBytes(ee.encode(e))
    }
    toArray() {
...
class ie extends s {
  ...
  get getImageData() {
    ...
    if (0 === this.doc.buffers.length || 0 === this.doc.bufferViews.length) throw new Error("")
    {
      const e = this.doc.bufferViews[this.bufferView],
        ...
        r = e.byteLength,
        i = t.bufferData
      if (void 0 !== i) return new re(i).skip(s).readBytes(r).buffer
    }
  }
  validate() {
    return (
  ...
  static fromJson(e) {
    ...
    if (((t.name = e.name), (t.bufferView = e.bufferView), void 0 !== e.mimeType)) {
      if (!(e.mimeType in S)) throw new Error("[GLTFImage.readFromJson()] 不支持的 mime 类型")
...
class ne extends s {
  ...
  json() {
    ...
    const s = {}
    return (
      e(s, "magFilter", this.magFilter),
      e(s, "minFilter", this.minFilter),
      e(s, "wrapS", this.wrapS),
      e(s, "wrapT", this.wrapT),
      e(s, "name", this.name),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
  ...
  static fromJson(e) {
    ...
    return (
      (t.name = e.name),
      void 0 !== e.magFilter && T.includes(e.magFilter) && (t.magFilter = e.magFilter),
      void 0 !== e.minFilter && T.includes(e.minFilter) && (t.minFilter = e.minFilter),
      void 0 !== e.wrapS && w.includes(e.wrapS) && (t.wrapS = e.wrapS),
      void 0 !== e.wrapT && w.includes(e.wrapT) && (t.wrapT = e.wrapT),
      (t.extras = e.extras),
      t
    )
  }
...
const ae = Object.freeze(Object.values(se))
class oe extends s {
  constructor() {
    super()
  }
  ...
  json() {
    ...
    return e(s, "node", this.node), t(s, this.extensions), e(s, "extras", this.extras), s
  }
  static readFromJson(e) {
    const t = new oe()
    return (
      (t.extras = e.extras),
      (t.node = e.node),
      void 0 !== e.path && ae.includes(e.path) && (t.path = e.path),
      t
    )
  }
}
class he extends s {
  ...
  static readFromJson(e) {
    const t = new he()
    return (t.sampler = e.sampler), (t.target = oe.readFromJson(e.target)), (t.extras = e.extras), t
  }
}
var ce
!(function (e) {
...
const ue = Object.freeze(Object.values(ce))
class le extends s {
  constructor() {
    super()
  }
  ...
  json() {
    const t = { input: this.input, output: this.output }
    return e(t, "interpolation", this.interpolation), t
  }
  static readFromJson(e) {
    const t = new le()
    return (
...
class de extends s {
  ...
  json() {
    ...
    return (
      e(s, "name", this.name),
      e(s, "channels", 0 !== this.channels.length ? this.channels.map((e) => e.json()) : void 0),
      e(s, "samplers", 0 !== this.samplers.length ? this.samplers.map((e) => e.json()) : void 0),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
  ...
  static fromJson(e) {
    ...
    return (
      (t.name = e.name),
      (t.channels = e.channels.map((e) => he.readFromJson(e))),
      (t.samplers = e.samplers.map((e) => le.readFromJson(e))),
      (t.extras = e.extras),
      t
    )
  }
...
const pe = Object.freeze(Object.values(fe))
class me {
  validate() {
    return (
      this.znear >= 0 &&
...
class ve {
  ...
  json() {
    ...
    const t = { yfov: this.yfov, znear: this.znear }
    return e(t, "aspectRatio", this.aspectRatio), e(t, "zfar", this.zfar), t
  }
}
class be extends s {
  constructor() {
  ...
  json() {
    ...
    return (
      e(s, "name", this.name),
      e(s, "perspective", this.perspective ? this.perspective.json() : void 0),
      e(s, "orthographic", this.orthographic ? this.orthographic.json() : void 0),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
...
class ge extends s {
  ...
  json() {
    ...
    const s = {}
    return (
      e(s, "inverseBindMatrices", this.inverseBindMatrices),
      e(s, "skeleton", this.skeleton),
      e(s, "name", this.name),
      e(s, "joints", 0 !== this.joints.length ? this.joints : void 0),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      s
    )
  ...
  json() {
    ...
    return (
      ...
      e(
        s,
        "skins",
        void 0 !== this.skins && 0 !== this.skins.length ? this.skins.map((e) => e.json()) : void 0
      ),
      t(s, this.extensions),
      e(s, "extras", this.extras),
      e(s, "extensionsUsed", this.extensionsUsed),
      e(s, "extensionsRequired", this.extensionsRequired),
      s
    )
  }
}
...
const ye = (e, ...t) => {
  ...
  return (
    ...
    (function (e, t) {
      for (const s of t) {
        const t = P.fromJson(s)
        e.push(t)
      }
    })(s.buffers, i.buffers),
    (function (e, t) {
      for (const s of t) {
        const t = z.fromJson(s)
        e.push(t)
      }
    })(s.bufferViews, i.bufferViews),
    (function (e, t) {
      for (const s of t) {
        const t = C.fromJson(s)
        e.push(t)
      }
...
;(exports.Asset = class {
    ...
    constructor(e, t = !1) {
      ;(this.header = new Fe()),
        (function (e, t) {
          ...
          if (((e.featureTable = Ie.createFromJSON(n, a)), 0 !== e.batchTableJSONByteLength)) {
            const t = JSON.parse(s.readChars(e.batchTableJSONByteLength)),
              r = s.readBytes(e.batchTableBinaryByteLength)
            e.batchTable = je.createFromJSON(t, r)
          }
        })(this, e),
        !0 === t && (this.buffer = e)
    }
  ...
  (exports.B3dmFeatureTable = Ie),
  (exports.B3dmHeader = Fe),
  (exports.BatchTable = je),
  (exports.Cmpt = class {}),
  (exports.ExtBatchtableHierarchy = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_batch_table_hierarchy")
    }
    load() {}
  }),
  (exports.ExtContentGLTF = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_content_gltf")
    }
  }),
  (exports.ExtDraco = class extends xe {
    constructor() {
  ...
  (exports.ExtGeometryMetadata = class extends xe {
    constructor() {
      super(...arguments), (this._name = "FB_geometry_metadata")
    }
  }),
  (exports.ExtImplicitTiling = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_implicit_tiling")
    }
  }),
  (exports.ExtLayers = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_layers")
    }
  }),
  (exports.ExtLod = class extends xe {
    constructor() {
      super(...arguments), (this._name = "MSFT_lod")
    }
  }),
  (exports.ExtMaterialsThinTransparency = class extends xe {
    constructor() {
      super(...arguments), (this._name = "ADOBE_materials_thin_transparency")
    }
  }),
  (exports.ExtMeshOptCompression = class extends xe {
    constructor() {
      super(...arguments), (this._name = "EXT_meshopt_compression")
    }
  }),
  (exports.ExtMetadata = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_metadata")
    }
  }),
  (exports.ExtMultipleContent = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_multiple_contents")
    }
  }),
  (exports.ExtPbrSpecularGlossiness = class extends xe {
    constructor() {
    ...
    json() {
      ...
      return (
        this.diffuseFactor &&
          ...
          e(t, "diffuseFactor", this.diffuseFactor),
        this.specularFactor &&
          !this.specularFactor.every((e) => 1 === e) &&
          e(t, "diffuseFactor", this.specularFactor),
        1 !== this.glossinessFactor && e(t, "glossinessFactor", this.glossinessFactor),
        void 0 !== this.diffuseTexture && e(t, "diffuseTexture", this.diffuseTexture.json()),
        void 0 !== this.specularGlossinessTexture &&
          e(t, "specularGlossinessTexture", this.specularGlossinessTexture.json()),
        t
      )
    }
  }),
  (exports.ExtPntsDraco = class extends Oe {
    constructor() {
      super(...arguments), (this.name = "3DTILES_draco_point_compression")
    }
  }),
  (exports.ExtPrimitiveOutline = class extends xe {
    constructor() {
      super(...arguments), (this._name = "CESIUM_primitive_outline")
    }
  }),
  (exports.ExtTextureDDS = class extends xe {
    constructor() {
      super(...arguments), (this._name = "MSFT_texture_dds")
    }
  }),
  (exports.ExtTextureWebp = class extends xe {
    constructor() {
      super(...arguments), (this._name = "EXT_texture_webp")
    }
  }),
  (exports.FeatureTable = Be),
  (exports.GLTFAccessor = C),
  (exports.GLTFAccessorSparse = j),
  (exports.GLTFAccessorSparseIndices = B),
  (exports.GLTFAccessorSparseValues = I),
  (exports.GLTFAddAction = class {
    constructor(e, t, s) {
      ;(this.type = "add"), (this.vertexArrayData = e), (this.material = t), (this.textureImage = s)
    }
    submit(e) {
      try {
        const t = C.fromJson({
        ...
        if ((e.scenes[void 0 === e.scene ? 0 : e.scene].nodes.push(a), void 0 !== this.material)) {
          void 0 === e.materials && (e.materials = [])
          let t = e.materials.length
          ;(s.material = t), e.materials.push(Z.fromJson(this.material))
        }
        let o
        if (
  ...
  (exports.GLTFAlphaMode = g),
  (exports.GLTFAnimation = de),
  (exports.GLTFAnimationChannel = he),
  (exports.GLTFAnimationChannelTarget = oe),
  (exports.GLTFAnimationSampler = le),
  (exports.GLTFAsset = o),
  (exports.GLTFAttributeType = l),
  (exports.GLTFBuffer = P),
  (exports.GLTFBufferView = z),
  (exports.GLTFCamera = be),
  (exports.GLTFComponentType = m),
  (exports.GLTFDocument = Te),
  (exports.GLTFDropAction = class {
    constructor() {
      this.type = "drop"
    }
    submit() {
  ...
  (exports.GLTFExtensionBase = xe),
  (exports.GLTFFilter = y),
  (exports.GLTFImage = ie),
  (exports.GLTFMaterial = Z),
  (exports.GLTFMesh = Q),
  (exports.GLTFNode = H),
  (exports.GLTFNormalTextureInfo = $),
  (exports.GLTFOcclusionTextureInfo = class extends q {
    constructor(e, t, s) {
    ...
    json() {
      ...
      const s = super.json()
      return e(s, "strength", this.strength), t(s, this.extensions), e(s, "extras", this.extras), s
    }
  }),
  (exports.GLTFOrthographicCamera = me),
  (exports.GLTFPbr = X),
  (exports.GLTFPerspectiveCamera = ve),
  (exports.GLTFPrimitive = Y),
  (exports.GLTFPrimitiveAttribute = W),
  (exports.GLTFPrimitiveBuilder = class {
    constructor(e) {
    ...
    setUV0(e) {
      ...
      const t = new Ee({ name: "uv0", data: e.buffer, elementType: l.VEC2, valueType: m.FLOAT })
      return this.vao.push(t), !0
    }
    setNormal(e) {
      if (e.length / 3 !== this.count) return !1
      const t = new Ee({ name: "normal", data: e.buffer, elementType: l.VEC3, valueType: m.FLOAT })
      return this.vao.push(t), !0
    }
    setIndices(e) {
      console.log(e)
    ...
    setOther(e, t, s, r) {
      const i = new Ee({ name: e, data: t, elementType: s, valueType: r })
      this.vao.push(i)
    }
    set mesh(e) {
      this._mesh = e
    ...
    submit(e) {
      ...
      if (
        ...
        this.vao.forEach((t, s, r) => {
          ...
          let p = e.buffers[0]
          void 0 === p && ((p = P.fromJson({ byteLength: 0 })), e.buffers.push(p))
          let m = void 0 === p.bufferData ? new ArrayBuffer(0) : p.bufferData
          ;(p.bufferData = (function (e, t) {
            ...
            (p.byteLength += t.data.byteLength)
        }),
  ...
  (exports.GLTFPrimitiveMode = F),
  (exports.GLTFSampler = ne),
  (exports.GLTFScene = k),
  (exports.GLTFSkin = ge),
  (exports.GLTFTexture = K),
  (exports.GLTFTextureInfo = q),
  (exports.GLTFUpdateAction = class {
    constructor() {
      this.type = "update"
    }
    submit() {
  ...
  (exports.GLTFVersion = a),
  (exports.GLTFVertexAttributeType = N),
  (exports.GLTFVertexAttributes = class {
    constructor() {
      ;(this.vertexBuffers = []), (this.primitiveMode = F.TRIANGLES)
    }
    validate() {
      return !1
    }
  ...
  (exports.GLTFVertexBuffer = class {
    constructor() {
      ;(this.type = N.POSITION), (this.numberType = m.FLOAT), (this.elementType = l.VEC3)
    }
    get count() {
      const e = f(this.numberType),
        t = c(this.elementType)
      if ((this.buffer.byteLength % e) * t != 0)
        throw new Error("[GLTFVertexBuffer count] 数据与类型不匹配，请检查")
      return this.buffer.byteLength / (e * t)
    }
  }),
  (exports.GLTFVertexBufferObject = Ee),
  (exports.GLTFVertexIndices = class {}),
  (exports.GLTFWrapMode = E),
  (exports.I3dm = class {
    constructor(e, t = !1) {
      ;(this.header = new Ce()),
        (function (e, t) {
          ...
          const n = JSON.parse(s.readChars(e.featureTableJSONByteLength)),
            a = s.readBytes(e.featureTableBinaryByteLength)
          if (((e.featureTable = Ge.createFromJSON(n, a)), 0 !== e.batchTableJSONByteLength)) {
            const t = JSON.parse(s.readChars(e.batchTableJSONByteLength)),
              r = s.readBytes(e.batchTableBinaryByteLength)
            e.batchTable = je.createFromJSON(t, r)
          }
  ...
  (exports.I3dmFeatureTable = Ge),
  (exports.I3dmHeader = Ce),
  (exports.MIME = S),
  (exports.Pnts = class {
    constructor(e, t = !1) {
      ;(this.header = new Re()),
  ...
  (exports.PntsFeatureTable = Je),
  (exports.PntsHeader = Re),
  ...
  (exports.Tile = class {
    ...
    toJson() {
      ...
      const e = {}
      void 0 !== this.transform && Object.defineProperty(e, "transform", { value: this.transform })
    }
  }),
  (exports.TileBoundingVolume = class {
    validate() {
      return (
        (void 0 === this.box ? 1 : 0) +
  ...
  (exports.TileHeaderBase = _e),
  (exports.TileRefine = Me),
  (exports.Tileset = class {
    constructor(e) {
      ;(this.extensions = new Set()),
        (this.extensionsUsed = []),
  ...
  (exports.TilesetExtBase = Oe),
  (exports.VERSION = Pe),
  (exports.VctrFeatureTable = Ue),
  (exports.readGLB = (e) => {
    const t = new re(e)
