(function (global, factory) {
  ...
  const GLTFAttributeTypeValues = Object.freeze(
    Object.values(GLTFAttributeType)
  );
  ...
  const GLTFComponentTypeValues = Object.freeze(
    Object.values(GLTFComponentType)
  );
  ...
  const GLTFPrimitiveModeValues = Object.freeze(
    Object.values(GLTFPrimitiveMode)
  );
  ...
  class GLTFAccessorSparse extends GLTFPropertyBase {
    ...
    validate() {
      return (
        this.count > 0 && this.values.validate() && this.indices.validate()
      );
    }
    json() {
      if (!this.validate()) {
  ...
  class GLTFAccessor extends GLTFPropertyBase {
    ...
    json() {
      if (!this.validate()) {
        throw new Error(
          "[GLTFAccessor json()] 当前 accessor 属性不合法，请检查"
        );
      }
      const acc = {
        componentType: this.componentType,
    ...
    static fromJson(json) {
      ...
      if (GLTFComponentTypeValues.includes(json.componentType)) {
        ...
        throw new Error(
          "[GLTFAccessor.readFromJson()] 属性 componentType 非法"
        );
      }
  ...
  (function (GLTFBufferViewTarget) {
    ...
    GLTFBufferViewTarget[
      (GLTFBufferViewTarget["ELEMENT_ARRAY_BUFFER"] = 34963)
  ...
  class GLTFImage extends GLTFPropertyBase {
    ...
    get getImageData() {
      ...
      if (this.doc === undefined) {
        ...
        if (
          this.doc.buffers.length === 0 ||
          this.doc.bufferViews.length === 0
        ) {
          throw new Error("");
        } else {
  ...
  class GLTFCamera extends GLTFPropertyBase {
    ...
    json() {
      if (!this.validate()) {
        throw new Error(
          "[GLTFCamera json()] 当前 camera 对象属性不合法，请检查"
        );
      }
      const camera = {
        type: this.type,
  ...
  class GLTFVertexAttributes {
    ...
    asPrimitive(doc, materialIndex) {
      ...
      prmt.attributes = createAttribute(
  ...
  const readGLTF = (json, ...resources) => {
    ...
    if (obj["skins"] !== undefined) {
      readSkins(
        doc.skins === undefined ? new Array() : doc.skins,
        obj["skins"]
      );
    }
