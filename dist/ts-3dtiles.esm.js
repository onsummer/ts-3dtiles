...
(function (GLTFFilter) {
    ...
    GLTFFilter[GLTFFilter["NEAREST_MIPMAP_NEAREST"] = 9984] = "NEAREST_MIPMAP_NEAREST";
    GLTFFilter[GLTFFilter["LINEAR_MIPMAP_NEAREST"] = 9985] = "LINEAR_MIPMAP_NEAREST";
    GLTFFilter[GLTFFilter["NEAREST_MIPMAP_LINEAR"] = 9986] = "NEAREST_MIPMAP_LINEAR";
    GLTFFilter[GLTFFilter["LINEAR_MIPMAP_LINEAR"] = 9987] = "LINEAR_MIPMAP_LINEAR";
...
class GLTFAccessorSparseIndices extends GLTFPropertyBase {
    ...
    validate() {
        if (this.componentType !== GLTFComponentType$1.UNSIGNED_BYTE &&
...
class GLTFBuffer extends GLTFPropertyBase {
    ...
    static fromJson(json) {
        ...
        if (bf.uri && isDataUrl(bf.uri)) {
            bf.bufferData = base64Arraybuffer_2(bf.uri.substr(bf.uri.indexOf(',') + 1));
        }
...
const GLTFBufferViewTargetValues = Object.freeze(Object.values(GLTFBufferViewTarget));
...
class GLTFBufferView extends GLTFPropertyBase {
    ...
    json() {
        ...
        if (this.target === GLTFBufferViewTarget$1.ARRAY_BUFFER || this.target === GLTFBufferViewTarget$1.ELEMENT_ARRAY_BUFFER) {
...
class GLTFPrimitive extends GLTFPropertyBase {
    ...
    json() {
        ...
        if (this.mode !== GLTFPrimitiveMode$1.TRIANGLES && this.mode !== undefined) {
...
class GLTFMaterial extends GLTFPropertyBase {
    ...
    validate() {
        ...
        if (this.alphaMode === GLTFAlphaMode$1.MASK && this.alphaCutoff === undefined) {
            return false;
        }
    ...
    json() {
        ...
        writeDefinedProperty(m, 'alphaMode', this.alphaMode !== undefined && this.alphaMode !== GLTFAlphaMode$1.OPAQUE ? this.alphaMode : undefined);
        ...
        if (this.doc === undefined) {
            ...
            if (this.doc.buffers.length === 0 || this.doc.bufferViews.length === 0) {
                ...
                if (bufferdata !== undefined) {
                    return new IOBuffer_2(bufferdata)
                        .skip(begin)
                        .readBytes(length)
                        .buffer;
                }
...
const GLTFAnimationChannelTargetPathValues = Object.freeze(Object.values(GLTFAnimationChannelTargetPath));
...
const GLTFAnimationInterpolationValues = Object.freeze(Object.values(GLTFAnimationInterpolation));
...
const readGLTF = (json, ...resources) => {
    ...
    if (obj['textures'] !== undefined) {
        readTextures(doc.textures === undefined ? new Array() : doc.textures, obj['textures']);
    }
    if (obj['images'] !== undefined) {
        readImages(doc.images === undefined ? new Array() : doc.images, obj['images']);
    }
    if (obj['materials'] !== undefined) {
        readMaterials(doc.materials === undefined ? new Array() : doc.materials, obj['materials']);
    }
    if (obj['samplers'] !== undefined) {
        readSamplers(doc.samplers === undefined ? new Array() : doc.samplers, obj['samplers']);
    }
    if (obj['animations'] !== undefined) {
        readAnimations(doc.animations === undefined ? new Array() : doc.animations, obj['animations']);
    }
    if (obj['skins'] !== undefined) {
        readSkins(doc.skins === undefined ? new Array() : doc.skins, obj['skins']);
    }
    if (obj['cameras'] !== undefined) {
        readCameras(doc.cameras === undefined ? new Array() : doc.cameras, obj['cameras']);
    }
    bind(doc);
    return doc;
};
...
function validateI3dmBatchTable(table) {
    ...
    if ((table.normalUp === undefined && table.normalRight !== undefined) ||
        (table.normalRight === undefined && table.normalUp !== undefined)) {
        return false;
    }
    if ((table.normalUpOct32p === undefined && table.normalRightOct32p !== undefined) ||
...
export { Asset, B3dm, B3dmFeatureTable, B3dmHeader, BatchTable, Cmpt, ExtBatchtableHierarchy, ExtContentGLTF, ExtDraco, ExtGeometryMetadata, ExtImplicitTiling, ExtLayers, ExtLod, ExtMaterialsThinTransparency, ExtMeshOptCompression, ExtMetadata, ExtMultipleContent, ExtPbrSpecularGlossiness, ExtPntsDraco, ExtPrimitiveOutline, ExtTextureDDS, ExtTextureWebp, FeatureTable, GLTFAccessor, GLTFAccessorSparse, GLTFAccessorSparseIndices, GLTFAccessorSparseValues, GLTFAddAction, GLTFAlphaMode$1 as GLTFAlphaMode, GLTFAnimation, GLTFAnimationChannel, GLTFAnimationChannelTarget, GLTFAnimationSampler, GLTFAsset, GLTFAttributeType$1 as GLTFAttributeType, GLTFBuffer, GLTFBufferView, GLTFCamera, GLTFComponentType$1 as GLTFComponentType, GLTFDocument, GLTFDropAction, GLTFExtensionBase, GLTFFilter$1 as GLTFFilter, GLTFImage, GLTFMaterial, GLTFMesh, GLTFNode, GLTFNormalTextureInfo, GLTFOcclusionTextureInfo, GLTFOrthographicCamera, GLTFPbr, GLTFPerspectiveCamera, GLTFPrimitive, GLTFPrimitiveAttribute, GLTFPrimitiveMode$1 as GLTFPrimitiveMode, GLTFSampler, GLTFScene, GLTFSkin, GLTFTexture, GLTFTextureInfo, GLTFUpdateAction, GLTFVersion$1 as GLTFVersion, GLTFVertexAttributeType$1 as GLTFVertexAttributeType, GLTFVertexAttributes, GLTFVertexBuffer, GLTFVertexIndices, GLTFWrapMode$1 as GLTFWrapMode, I3dm, I3dmFeatureTable, I3dmHeader, MIME$1 as MIME, Pnts, PntsFeatureTable, PntsHeader, Property, Tile, TileBoundingVolume, TileContent, TileHeaderBase, TileRefine$1 as TileRefine, Tileset, TilesetExtBase, VctrFeatureTable, readGLB, readGLTF };
